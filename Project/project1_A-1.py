#################################################################################
# Program to explore and visualize a dataset by finding  correlated variables   #
# do statstical analysis of the data and do a pairplot of the data              #
#################################################################################
...
def correl_matrix(X):
    # create a figure that's 7x7 with 100 dots per inch
...
def pairplotting(df,features_label):
...
pairplotting(data, features_label)                                              # generate the pair plot
