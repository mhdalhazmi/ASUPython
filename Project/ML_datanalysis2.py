...
mosthighlycorrelated(iris,5)                # generate most highly correlated list
correl_matrix(iris)                         # generate the covariance heat plot
pairplotting(iris)                          # generate the pair plot
